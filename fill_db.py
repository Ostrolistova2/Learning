...
if __name__ == '__main__':
    ...
    subject_storage.add_content('Что изучает математика?', '_____________текст по теме Что изучает математика?____________', '1+2=\n3+3=\n5+6=', 'СР допустим', 'КР допустимммммм', '1+2=3\n3+3=6\n5+6=11')
