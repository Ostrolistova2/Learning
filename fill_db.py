...
if __name__ == '__main__':
    ...
    subject_storage.add_content('Что изучает математика?', '_____________текст по теме Что изучает математика?____________', 'упражнения какие - то допустим', 'СР допустим', 'КР допустимммммм')
