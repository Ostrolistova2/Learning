...
if __name__ == '__main__':
    logger = logging.getLogger('log/lessons_log')
    ...
    subject_storage.add_topic('Физика', 'Что изучает физика?', 7)
    ...
    subject_storage.add_topic('Физическая культура', 'Отжимания', 4)
    ...
    subject_storage.add_content('Спряжение глаголов', '_________________ТЕКСТ О СПРЯЖЕНИИ ГЛАГОЛОВ_______________')
    ...
    subject_storage.add_content('Воийна и мир', '_________________АНАЛИЗ_______________')
    subject_storage.add_content('Спряжение глаголов', '_________________ТЕКСТ О СПРЯЖЕНИИ ГЛАГОЛОВ_______________')
    subject_storage.add_content('Спряжение глаголов', '_________________ВИДЕО О СПРЯЖЕНИИ ГЛАГОЛОВ_______________')
    subject_storage.add_content('Спряжение глаголов', '_________________УПРАЖНЕНИЯ НА СПРЯЖЕНИЕ ГЛАГОЛОВ_______________')
    subject_storage.show_contents()

    subject_storage.get_sb()
